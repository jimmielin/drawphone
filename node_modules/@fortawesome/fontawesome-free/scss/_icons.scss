...
.#{$fa-css-prefix}-adobe:before {
	content: fa-content($fa-var-adobe);
}
...
.#{$fa-css-prefix}-airbnb:before {
	content: fa-content($fa-var-airbnb);
}
...
.#{$fa-css-prefix}-artstation:before {
	content: fa-content($fa-var-artstation);
}
...
.#{$fa-css-prefix}-atlassian:before {
	content: fa-content($fa-var-atlassian);
}
...
.#{$fa-css-prefix}-baby:before {
	content: fa-content($fa-var-baby);
}
.#{$fa-css-prefix}-baby-carriage:before {
	content: fa-content($fa-var-baby-carriage);
}
...
.#{$fa-css-prefix}-bacon:before {
	content: fa-content($fa-var-bacon);
}
.#{$fa-css-prefix}-bacteria:before {
	content: fa-content($fa-var-bacteria);
}
.#{$fa-css-prefix}-bacterium:before {
	content: fa-content($fa-var-bacterium);
}
.#{$fa-css-prefix}-bahai:before {
	content: fa-content($fa-var-bahai);
}
.#{$fa-css-prefix}-balance-scale:before {
	content: fa-content($fa-var-balance-scale);
}
.#{$fa-css-prefix}-balance-scale-left:before {
	content: fa-content($fa-var-balance-scale-left);
}
.#{$fa-css-prefix}-balance-scale-right:before {
	content: fa-content($fa-var-balance-scale-right);
}
...
.#{$fa-css-prefix}-battle-net:before {
	content: fa-content($fa-var-battle-net);
}
...
.#{$fa-css-prefix}-biking:before {
	content: fa-content($fa-var-biking);
}
...
.#{$fa-css-prefix}-biohazard:before {
	content: fa-content($fa-var-biohazard);
}
...
.#{$fa-css-prefix}-blender-phone:before {
	content: fa-content($fa-var-blender-phone);
}
.#{$fa-css-prefix}-blind:before {
	content: fa-content($fa-var-blind);
}
.#{$fa-css-prefix}-blog:before {
	content: fa-content($fa-var-blog);
}
...
.#{$fa-css-prefix}-book-dead:before {
	content: fa-content($fa-var-book-dead);
}
.#{$fa-css-prefix}-book-medical:before {
	content: fa-content($fa-var-book-medical);
}
...
.#{$fa-css-prefix}-bootstrap:before {
	content: fa-content($fa-var-bootstrap);
}
.#{$fa-css-prefix}-border-all:before {
	content: fa-content($fa-var-border-all);
}
.#{$fa-css-prefix}-border-none:before {
	content: fa-content($fa-var-border-none);
}
.#{$fa-css-prefix}-border-style:before {
	content: fa-content($fa-var-border-style);
}
...
.#{$fa-css-prefix}-box-tissue:before {
	content: fa-content($fa-var-box-tissue);
}
...
.#{$fa-css-prefix}-bread-slice:before {
	content: fa-content($fa-var-bread-slice);
}
...
.#{$fa-css-prefix}-buy-n-large:before {
	content: fa-content($fa-var-buy-n-large);
}
...
.#{$fa-css-prefix}-calendar-day:before {
...
.#{$fa-css-prefix}-calendar-week:before {
	content: fa-content($fa-var-calendar-week);
}
...
.#{$fa-css-prefix}-campground:before {
	content: fa-content($fa-var-campground);
}
.#{$fa-css-prefix}-canadian-maple-leaf:before {
	content: fa-content($fa-var-canadian-maple-leaf);
}
.#{$fa-css-prefix}-candy-cane:before {
	content: fa-content($fa-var-candy-cane);
}
...
.#{$fa-css-prefix}-caravan:before {
	content: fa-content($fa-var-caravan);
}
...
.#{$fa-css-prefix}-cash-register:before {
	content: fa-content($fa-var-cash-register);
}
.#{$fa-css-prefix}-cat:before {
	content: fa-content($fa-var-cat);
}
...
.#{$fa-css-prefix}-cheese:before {
	content: fa-content($fa-var-cheese);
}
...
.#{$fa-css-prefix}-chromecast:before {
	content: fa-content($fa-var-chromecast);
}
...
.#{$fa-css-prefix}-clinic-medical:before {
	content: fa-content($fa-var-clinic-medical);
}
...
.#{$fa-css-prefix}-cloud-meatball:before {
	content: fa-content($fa-var-cloud-meatball);
}
.#{$fa-css-prefix}-cloud-moon:before {
	content: fa-content($fa-var-cloud-moon);
}
.#{$fa-css-prefix}-cloud-moon-rain:before {
	content: fa-content($fa-var-cloud-moon-rain);
}
.#{$fa-css-prefix}-cloud-rain:before {
	content: fa-content($fa-var-cloud-rain);
}
.#{$fa-css-prefix}-cloud-showers-heavy:before {
	content: fa-content($fa-var-cloud-showers-heavy);
}
.#{$fa-css-prefix}-cloud-sun:before {
	content: fa-content($fa-var-cloud-sun);
}
.#{$fa-css-prefix}-cloud-sun-rain:before {
	content: fa-content($fa-var-cloud-sun-rain);
}
...
.#{$fa-css-prefix}-comment-medical:before {
	content: fa-content($fa-var-comment-medical);
}
...
.#{$fa-css-prefix}-compress-alt:before {
	content: fa-content($fa-var-compress-alt);
}
.#{$fa-css-prefix}-compress-arrows-alt:before {
	content: fa-content($fa-var-compress-arrows-alt);
}
.#{$fa-css-prefix}-concierge-bell:before {
	content: fa-content($fa-var-concierge-bell);
}
.#{$fa-css-prefix}-confluence:before {
	content: fa-content($fa-var-confluence);
}
...
.#{$fa-css-prefix}-cotton-bureau:before {
	content: fa-content($fa-var-cotton-bureau);
}
...
.#{$fa-css-prefix}-crutch:before {
	content: fa-content($fa-var-crutch);
}
...
.#{$fa-css-prefix}-d-and-d-beyond:before {
	content: fa-content($fa-var-d-and-d-beyond);
}
.#{$fa-css-prefix}-dailymotion:before {
	content: fa-content($fa-var-dailymotion);
}
...
.#{$fa-css-prefix}-dhl:before {
	content: fa-content($fa-var-dhl);
}
.#{$fa-css-prefix}-diagnoses:before {
	content: fa-content($fa-var-diagnoses);
}
.#{$fa-css-prefix}-diaspora:before {
...
.#{$fa-css-prefix}-dice-d6:before {
	content: fa-content($fa-var-dice-d6);
}
...
.#{$fa-css-prefix}-disease:before {
	content: fa-content($fa-var-disease);
}
...
.#{$fa-css-prefix}-dragon:before {
	content: fa-content($fa-var-dragon);
}
...
.#{$fa-css-prefix}-drumstick-bite:before {
	content: fa-content($fa-var-drumstick-bite);
}
...
.#{$fa-css-prefix}-dumpster:before {
	content: fa-content($fa-var-dumpster);
}
.#{$fa-css-prefix}-dumpster-fire:before {
	content: fa-content($fa-var-dumpster-fire);
}
.#{$fa-css-prefix}-dungeon:before {
	content: fa-content($fa-var-dungeon);
}
...
.#{$fa-css-prefix}-edge-legacy:before {
	content: fa-content($fa-var-edge-legacy);
}
.#{$fa-css-prefix}-edit:before {
	content: fa-content($fa-var-edit);
}
.#{$fa-css-prefix}-egg:before {
	content: fa-content($fa-var-egg);
}
...
.#{$fa-css-prefix}-evernote:before {
	content: fa-content($fa-var-evernote);
}
...
.#{$fa-css-prefix}-expand-alt:before {
...
.#{$fa-css-prefix}-fan:before {
	content: fa-content($fa-var-fan);
}
.#{$fa-css-prefix}-fantasy-flight-games:before {
	content: fa-content($fa-var-fantasy-flight-games);
}
...
.#{$fa-css-prefix}-faucet:before {
	content: fa-content($fa-var-faucet);
}
...
.#{$fa-css-prefix}-fedex:before {
	content: fa-content($fa-var-fedex);
}
.#{$fa-css-prefix}-fedora:before {
	content: fa-content($fa-var-fedora);
}
...
.#{$fa-css-prefix}-figma:before {
	content: fa-content($fa-var-figma);
}
...
.#{$fa-css-prefix}-fire-alt:before {
	content: fa-content($fa-var-fire-alt);
}
...
.#{$fa-css-prefix}-firefox-browser:before {
	content: fa-content($fa-var-firefox-browser);
}
...
.#{$fa-css-prefix}-fist-raised:before {
	content: fa-content($fa-var-fist-raised);
}
...
.#{$fa-css-prefix}-flag-usa:before {
	content: fa-content($fa-var-flag-usa);
}
...
.#{$fa-css-prefix}-ghost:before {
	content: fa-content($fa-var-ghost);
}
.#{$fa-css-prefix}-gift:before {
	content: fa-content($fa-var-gift);
}
.#{$fa-css-prefix}-gifts:before {
	content: fa-content($fa-var-gifts);
}
.#{$fa-css-prefix}-git:before {
	content: fa-content($fa-var-git);
}
.#{$fa-css-prefix}-git-alt:before {
	content: fa-content($fa-var-git-alt);
}
...
.#{$fa-css-prefix}-glass-cheers:before {
	content: fa-content($fa-var-glass-cheers);
}
...
.#{$fa-css-prefix}-glass-whiskey:before {
	content: fa-content($fa-var-glass-whiskey);
}
...
.#{$fa-css-prefix}-globe-europe:before {
	content: fa-content($fa-var-globe-europe);
}
...
.#{$fa-css-prefix}-google-pay:before {
	content: fa-content($fa-var-google-pay);
}
...
.#{$fa-css-prefix}-grip-lines:before {
	content: fa-content($fa-var-grip-lines);
}
.#{$fa-css-prefix}-grip-lines-vertical:before {
...
.#{$fa-css-prefix}-guitar:before {
	content: fa-content($fa-var-guitar);
}
...
.#{$fa-css-prefix}-hamburger:before {
	content: fa-content($fa-var-hamburger);
}
.#{$fa-css-prefix}-hammer:before {
	content: fa-content($fa-var-hammer);
}
...
.#{$fa-css-prefix}-hand-holding-medical:before {
	content: fa-content($fa-var-hand-holding-medical);
}
.#{$fa-css-prefix}-hand-holding-usd:before {
	content: fa-content($fa-var-hand-holding-usd);
}
.#{$fa-css-prefix}-hand-holding-water:before {
	content: fa-content($fa-var-hand-holding-water);
}
.#{$fa-css-prefix}-hand-lizard:before {
	content: fa-content($fa-var-hand-lizard);
}
.#{$fa-css-prefix}-hand-middle-finger:before {
	content: fa-content($fa-var-hand-middle-finger);
}
...
.#{$fa-css-prefix}-hand-sparkles:before {
	content: fa-content($fa-var-hand-sparkles);
}
...
.#{$fa-css-prefix}-hands-wash:before {
	content: fa-content($fa-var-hands-wash);
}
.#{$fa-css-prefix}-handshake:before {
	content: fa-content($fa-var-handshake);
}
.#{$fa-css-prefix}-handshake-alt-slash:before {
	content: fa-content($fa-var-handshake-alt-slash);
}
.#{$fa-css-prefix}-handshake-slash:before {
	content: fa-content($fa-var-handshake-slash);
}
.#{$fa-css-prefix}-hanukiah:before {
	content: fa-content($fa-var-hanukiah);
}
.#{$fa-css-prefix}-hard-hat:before {
	content: fa-content($fa-var-hard-hat);
}
.#{$fa-css-prefix}-hashtag:before {
	content: fa-content($fa-var-hashtag);
}
.#{$fa-css-prefix}-hat-cowboy:before {
	content: fa-content($fa-var-hat-cowboy);
}
.#{$fa-css-prefix}-hat-cowboy-side:before {
	content: fa-content($fa-var-hat-cowboy-side);
}
.#{$fa-css-prefix}-hat-wizard:before {
	content: fa-content($fa-var-hat-wizard);
}
.#{$fa-css-prefix}-hdd:before {
	content: fa-content($fa-var-hdd);
}
.#{$fa-css-prefix}-head-side-cough:before {
	content: fa-content($fa-var-head-side-cough);
}
.#{$fa-css-prefix}-head-side-cough-slash:before {
	content: fa-content($fa-var-head-side-cough-slash);
}
.#{$fa-css-prefix}-head-side-mask:before {
	content: fa-content($fa-var-head-side-mask);
}
.#{$fa-css-prefix}-head-side-virus:before {
	content: fa-content($fa-var-head-side-virus);
}
...
.#{$fa-css-prefix}-heart-broken:before {
	content: fa-content($fa-var-heart-broken);
}
...
.#{$fa-css-prefix}-hiking:before {
	content: fa-content($fa-var-hiking);
}
.#{$fa-css-prefix}-hippo:before {
	content: fa-content($fa-var-hippo);
}
...
.#{$fa-css-prefix}-holly-berry:before {
	content: fa-content($fa-var-holly-berry);
}
...
.#{$fa-css-prefix}-horse:before {
	content: fa-content($fa-var-horse);
}
.#{$fa-css-prefix}-horse-head:before {
	content: fa-content($fa-var-horse-head);
}
...
.#{$fa-css-prefix}-hospital-user:before {
	content: fa-content($fa-var-hospital-user);
}
.#{$fa-css-prefix}-hot-tub:before {
	content: fa-content($fa-var-hot-tub);
}
.#{$fa-css-prefix}-hotdog:before {
	content: fa-content($fa-var-hotdog);
}
...
.#{$fa-css-prefix}-house-damage:before {
	content: fa-content($fa-var-house-damage);
}
.#{$fa-css-prefix}-house-user:before {
...
.#{$fa-css-prefix}-hryvnia:before {
	content: fa-content($fa-var-hryvnia);
}
...
.#{$fa-css-prefix}-ice-cream:before {
	content: fa-content($fa-var-ice-cream);
}
.#{$fa-css-prefix}-icicles:before {
	content: fa-content($fa-var-icicles);
}
.#{$fa-css-prefix}-icons:before {
	content: fa-content($fa-var-icons);
}
...
.#{$fa-css-prefix}-ideal:before {
	content: fa-content($fa-var-ideal);
}
.#{$fa-css-prefix}-igloo:before {
...
.#{$fa-css-prefix}-instagram-square:before {
	content: fa-content($fa-var-instagram-square);
}
.#{$fa-css-prefix}-intercom:before {
	content: fa-content($fa-var-intercom);
}
.#{$fa-css-prefix}-internet-explorer:before {
	content: fa-content($fa-var-internet-explorer);
}
.#{$fa-css-prefix}-invision:before {
	content: fa-content($fa-var-invision);
}
...
.#{$fa-css-prefix}-jira:before {
	content: fa-content($fa-var-jira);
}
...
.#{$fa-css-prefix}-laptop-house:before {
	content: fa-content($fa-var-laptop-house);
}
.#{$fa-css-prefix}-laptop-medical:before {
	content: fa-content($fa-var-laptop-medical);
}
...
.#{$fa-css-prefix}-lungs:before {
	content: fa-content($fa-var-lungs);
}
.#{$fa-css-prefix}-lungs-virus:before {
	content: fa-content($fa-var-lungs-virus);
}
...
.#{$fa-css-prefix}-mask:before {
	content: fa-content($fa-var-mask);
}
...
.#{$fa-css-prefix}-mdb:before {
	content: fa-content($fa-var-mdb);
}
...
.#{$fa-css-prefix}-mendeley:before {
	content: fa-content($fa-var-mendeley);
}
...
.#{$fa-css-prefix}-meteor:before {
	content: fa-content($fa-var-meteor);
}
.#{$fa-css-prefix}-microblog:before {
	content: fa-content($fa-var-microblog);
}
...
.#{$fa-css-prefix}-mitten:before {
	content: fa-content($fa-var-mitten);
}
...
.#{$fa-css-prefix}-mountain:before {
	content: fa-content($fa-var-mountain);
}
.#{$fa-css-prefix}-mouse:before {
	content: fa-content($fa-var-mouse);
}
.#{$fa-css-prefix}-mouse-pointer:before {
	content: fa-content($fa-var-mouse-pointer);
}
.#{$fa-css-prefix}-mug-hot:before {
	content: fa-content($fa-var-mug-hot);
}
...
.#{$fa-css-prefix}-network-wired:before {
	content: fa-content($fa-var-network-wired);
}
...
.#{$fa-css-prefix}-orcid:before {
	content: fa-content($fa-var-orcid);
}
.#{$fa-css-prefix}-osi:before {
	content: fa-content($fa-var-osi);
}
.#{$fa-css-prefix}-otter:before {
	content: fa-content($fa-var-otter);
}
...
.#{$fa-css-prefix}-penny-arcade:before {
	content: fa-content($fa-var-penny-arcade);
}
.#{$fa-css-prefix}-people-arrows:before {
	content: fa-content($fa-var-people-arrows);
}
.#{$fa-css-prefix}-people-carry:before {
	content: fa-content($fa-var-people-carry);
}
.#{$fa-css-prefix}-pepper-hot:before {
	content: fa-content($fa-var-pepper-hot);
}
...
.#{$fa-css-prefix}-person-booth:before {
	content: fa-content($fa-var-person-booth);
}
...
.#{$fa-css-prefix}-phone-alt:before {
...
.#{$fa-css-prefix}-pied-piper-square:before {
	content: fa-content($fa-var-pied-piper-square);
}
...
.#{$fa-css-prefix}-pizza-slice:before {
	content: fa-content($fa-var-pizza-slice);
}
...
.#{$fa-css-prefix}-plane-slash:before {
	content: fa-content($fa-var-plane-slash);
}
...
.#{$fa-css-prefix}-poo-storm:before {
	content: fa-content($fa-var-poo-storm);
}
...
.#{$fa-css-prefix}-pump-medical:before {
	content: fa-content($fa-var-pump-medical);
}
.#{$fa-css-prefix}-pump-soap:before {
	content: fa-content($fa-var-pump-soap);
}
...
.#{$fa-css-prefix}-radiation:before {
	content: fa-content($fa-var-radiation);
}
.#{$fa-css-prefix}-radiation-alt:before {
	content: fa-content($fa-var-radiation-alt);
}
.#{$fa-css-prefix}-rainbow:before {
	content: fa-content($fa-var-rainbow);
}
.#{$fa-css-prefix}-random:before {
	content: fa-content($fa-var-random);
}
.#{$fa-css-prefix}-raspberry-pi:before {
	content: fa-content($fa-var-raspberry-pi);
}
...
.#{$fa-css-prefix}-reacteurope:before {
	content: fa-content($fa-var-reacteurope);
}
...
.#{$fa-css-prefix}-record-vinyl:before {
	content: fa-content($fa-var-record-vinyl);
}
...
.#{$fa-css-prefix}-redhat:before {
	content: fa-content($fa-var-redhat);
}
...
.#{$fa-css-prefix}-remove-format:before {
	content: fa-content($fa-var-remove-format);
}
...
.#{$fa-css-prefix}-republican:before {
	content: fa-content($fa-var-republican);
}
...
.#{$fa-css-prefix}-restroom:before {
	content: fa-content($fa-var-restroom);
}
...
.#{$fa-css-prefix}-ring:before {
	content: fa-content($fa-var-ring);
}
...
.#{$fa-css-prefix}-running:before {
	content: fa-content($fa-var-running);
}
.#{$fa-css-prefix}-rupee-sign:before {
	content: fa-content($fa-var-rupee-sign);
}
.#{$fa-css-prefix}-rust:before {
	content: fa-content($fa-var-rust);
}
...
.#{$fa-css-prefix}-salesforce:before {
	content: fa-content($fa-var-salesforce);
}
.#{$fa-css-prefix}-sass:before {
	content: fa-content($fa-var-sass);
}
.#{$fa-css-prefix}-satellite:before {
	content: fa-content($fa-var-satellite);
}
.#{$fa-css-prefix}-satellite-dish:before {
	content: fa-content($fa-var-satellite-dish);
}
...
.#{$fa-css-prefix}-sd-card:before {
	content: fa-content($fa-var-sd-card);
}
...
.#{$fa-css-prefix}-shield-virus:before {
	content: fa-content($fa-var-shield-virus);
}
...
.#{$fa-css-prefix}-shopify:before {
	content: fa-content($fa-var-shopify);
}
...
.#{$fa-css-prefix}-sim-card:before {
	content: fa-content($fa-var-sim-card);
}
.#{$fa-css-prefix}-simplybuilt:before {
	content: fa-content($fa-var-simplybuilt);
}
.#{$fa-css-prefix}-sink:before {
	content: fa-content($fa-var-sink);
}
...
.#{$fa-css-prefix}-skating:before {
	content: fa-content($fa-var-skating);
}
.#{$fa-css-prefix}-sketch:before {
	content: fa-content($fa-var-sketch);
}
.#{$fa-css-prefix}-skiing:before {
	content: fa-content($fa-var-skiing);
}
.#{$fa-css-prefix}-skiing-nordic:before {
	content: fa-content($fa-var-skiing-nordic);
}
.#{$fa-css-prefix}-skull:before {
	content: fa-content($fa-var-skull);
}
.#{$fa-css-prefix}-skull-crossbones:before {
	content: fa-content($fa-var-skull-crossbones);
}
...
.#{$fa-css-prefix}-slash:before {
	content: fa-content($fa-var-slash);
}
.#{$fa-css-prefix}-sleigh:before {
	content: fa-content($fa-var-sleigh);
}
...
.#{$fa-css-prefix}-smog:before {
	content: fa-content($fa-var-smog);
}
...
.#{$fa-css-prefix}-sms:before {
	content: fa-content($fa-var-sms);
}
...
.#{$fa-css-prefix}-snowboarding:before {
	content: fa-content($fa-var-snowboarding);
}
.#{$fa-css-prefix}-snowflake:before {
	content: fa-content($fa-var-snowflake);
}
.#{$fa-css-prefix}-snowman:before {
	content: fa-content($fa-var-snowman);
}
.#{$fa-css-prefix}-snowplow:before {
	content: fa-content($fa-var-snowplow);
}
.#{$fa-css-prefix}-soap:before {
	content: fa-content($fa-var-soap);
}
...
.#{$fa-css-prefix}-sort-amount-up-alt:before {
	content: fa-content($fa-var-sort-amount-up-alt);
}
...
.#{$fa-css-prefix}-sort-numeric-down-alt:before {
...
.#{$fa-css-prefix}-sort-numeric-up-alt:before {
	content: fa-content($fa-var-sort-numeric-up-alt);
}
...
.#{$fa-css-prefix}-sourcetree:before {
	content: fa-content($fa-var-sourcetree);
}
...
.#{$fa-css-prefix}-speaker-deck:before {
	content: fa-content($fa-var-speaker-deck);
}
.#{$fa-css-prefix}-spell-check:before {
	content: fa-content($fa-var-spell-check);
}
.#{$fa-css-prefix}-spider:before {
	content: fa-content($fa-var-spider);
}
...
.#{$fa-css-prefix}-stackpath:before {
	content: fa-content($fa-var-stackpath);
}
...
.#{$fa-css-prefix}-stopwatch-20:before {
	content: fa-content($fa-var-stopwatch-20);
}
...
.#{$fa-css-prefix}-store-alt-slash:before {
	content: fa-content($fa-var-store-alt-slash);
}
.#{$fa-css-prefix}-store-slash:before {
	content: fa-content($fa-var-store-slash);
}
...
.#{$fa-css-prefix}-suse:before {
	content: fa-content($fa-var-suse);
}
.#{$fa-css-prefix}-swatchbook:before {
	content: fa-content($fa-var-swatchbook);
}
.#{$fa-css-prefix}-swift:before {
	content: fa-content($fa-var-swift);
}
...
.#{$fa-css-prefix}-symfony:before {
	content: fa-content($fa-var-symfony);
}
...
.#{$fa-css-prefix}-temperature-high:before {
	content: fa-content($fa-var-temperature-high);
}
.#{$fa-css-prefix}-temperature-low:before {
	content: fa-content($fa-var-temperature-low);
}
.#{$fa-css-prefix}-tencent-weibo:before {
	content: fa-content($fa-var-tencent-weibo);
}
.#{$fa-css-prefix}-tenge:before {
	content: fa-content($fa-var-tenge);
}
...
.#{$fa-css-prefix}-think-peaks:before {
	content: fa-content($fa-var-think-peaks);
}
...
.#{$fa-css-prefix}-toilet:before {
	content: fa-content($fa-var-toilet);
}
.#{$fa-css-prefix}-toilet-paper:before {
	content: fa-content($fa-var-toilet-paper);
}
.#{$fa-css-prefix}-toilet-paper-slash:before {
	content: fa-content($fa-var-toilet-paper-slash);
}
.#{$fa-css-prefix}-toolbox:before {
	content: fa-content($fa-var-toolbox);
}
.#{$fa-css-prefix}-tools:before {
...
.#{$fa-css-prefix}-trailer:before {
	content: fa-content($fa-var-trailer);
}
.#{$fa-css-prefix}-train:before {
	content: fa-content($fa-var-train);
}
.#{$fa-css-prefix}-tram:before {
	content: fa-content($fa-var-tram);
}
...
.#{$fa-css-prefix}-trash-restore:before {
	content: fa-content($fa-var-trash-restore);
}
.#{$fa-css-prefix}-trash-restore-alt:before {
	content: fa-content($fa-var-trash-restore-alt);
}
...
.#{$fa-css-prefix}-ubuntu:before {
	content: fa-content($fa-var-ubuntu);
}
.#{$fa-css-prefix}-uikit:before {
	content: fa-content($fa-var-uikit);
}
.#{$fa-css-prefix}-umbraco:before {
	content: fa-content($fa-var-umbraco);
}
...
.#{$fa-css-prefix}-unsplash:before {
	content: fa-content($fa-var-unsplash);
}
...
.#{$fa-css-prefix}-ups:before {
	content: fa-content($fa-var-ups);
}
...
.#{$fa-css-prefix}-user-injured:before {
	content: fa-content($fa-var-user-injured);
}
...
.#{$fa-css-prefix}-user-nurse:before {
	content: fa-content($fa-var-user-nurse);
}
...
.#{$fa-css-prefix}-users-slash:before {
	content: fa-content($fa-var-users-slash);
}
.#{$fa-css-prefix}-usps:before {
	content: fa-content($fa-var-usps);
}
...
.#{$fa-css-prefix}-virus:before {
	content: fa-content($fa-var-virus);
}
.#{$fa-css-prefix}-virus-slash:before {
	content: fa-content($fa-var-virus-slash);
}
.#{$fa-css-prefix}-viruses:before {
	content: fa-content($fa-var-viruses);
}
...
.#{$fa-css-prefix}-voicemail:before {
...
.#{$fa-css-prefix}-vote-yea:before {
	content: fa-content($fa-var-vote-yea);
}
.#{$fa-css-prefix}-vr-cardboard:before {
	content: fa-content($fa-var-vr-cardboard);
}
...
.#{$fa-css-prefix}-water:before {
	content: fa-content($fa-var-water);
}
.#{$fa-css-prefix}-wave-square:before {
	content: fa-content($fa-var-wave-square);
}
.#{$fa-css-prefix}-waze:before {
	content: fa-content($fa-var-waze);
}
...
.#{$fa-css-prefix}-wind:before {
	content: fa-content($fa-var-wind);
}
...
.#{$fa-css-prefix}-wine-bottle:before {
	content: fa-content($fa-var-wine-bottle);
}
...
.#{$fa-css-prefix}-wizards-of-the-coast:before {
	content: fa-content($fa-var-wizards-of-the-coast);
}
...
.#{$fa-css-prefix}-wpressr:before {
	content: fa-content($fa-var-wpressr);
}
...
.#{$fa-css-prefix}-yammer:before {
	content: fa-content($fa-var-yammer);
}
...
.#{$fa-css-prefix}-yarn:before {
	content: fa-content($fa-var-yarn);
}
